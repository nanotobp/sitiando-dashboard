...
Route::middleware(['auth'])
    ...
    ->group(function () {
        ...
        /* ANALYTICS AFILIADOS */
        Route::get('/analytics/affiliates', [AffiliateAnalyticsController::class, 'index'])
            ->name('analytics.affiliates');

        Route::get('/analytics/affiliates/{id}', [AffiliateAnalyticsDetailController::class, 'show'])
